...
from evaluate.evaluate import validate_things
...
def get_args_parser():
    ...
    parser.add_argument('--val_dataset', default=['things'], type=str, nargs='+',  # , 'kitti15'
                        help='waymo / things / kitti15')
    parser.add_argument('--root', default='', type=str,
                        help="particle dataset root")  
    parser.add_argument('--dataset', default='MICROTUBULE', type=str,
                        help="choose dataset from 'RECEPTOR' and 'MICROTUBULE' and 'VESICLE'")                 
    parser.add_argument('--snr',default=7,type=int,
                        help="snr of the dataset")
    parser.add_argument('--density',default='low',type=str,
                        help="density of the dataset")
    parser.add_argument('--npoints',type=int,
                        help="points num of the dataset")    
    # training

...
class Model(nn.Module):
    def __init__(self, 
        ...
        if pretrained != '':
            if os.path.exists(pretrained):
                print("load amt from: ", pretrained)
                pretrained_amt = torch.load(pretrained)
                self.load_state_dict(pretrained_amt)
            else:
    ...
    def forward(self, img0, img1, feature_map_0, feature_map_1, flow_map_0, flow_map_1, embt, scale_factor=1.0, eval=False, **kwargs):
        ...
        pft0_1_, pft0_2_, pft0_3_ = feature_map_0
        pft1_1_, pft1_2_, pft1_3_ = feature_map_1
        pflow0_2, pflow0_3, pflow0_4 = flow_map_0
        pflow1_2, pflow1_3, pflow1_4 = flow_map_1
        ...
        ######################################### the 3rd decoder #########################################
        up_flow0_3, up_flow1_3, ft_2_ = self.decoder3(ft_3_, pft0_3_, pft1_3_, f0_3, f1_3, up_flow0_4, up_flow1_4, pflow0_4, pflow1_4)
        ...
        ######################################### the 2nd decoder #########################################
        up_flow0_2, up_flow1_2, ft_1_  = self.decoder2(ft_2_, pft0_2_, pft1_2_, f0_2, f1_2, up_flow0_3, up_flow1_3, pflow0_3, pflow1_3)
        ...
        ######################################### the 1st decoder #########################################
        up_flow0_1, up_flow1_1, mask, img_res = self.decoder1(ft_1_, pft0_1_, pft1_1_, f0_1, f1_1, up_flow0_2, up_flow1_2, pflow0_2, pflow1_2)

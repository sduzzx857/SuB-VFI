...
class FeatureTransformer3D(nn.Module):
    ...
    def forward(self, feature0, feature1,
        ...
        for i, layer in enumerate(self.layers):
            feature0 = layer(feature0, feature1, height=n0, width=1)
            feature1 = layer(feature1, feature0, height=n1, width=1)

        

        # reshape back
        feature0 = feature0.view(b, n0, c).permute(0, 2, 1).contiguous()  # [B, C, N]
        feature1 = feature1.view(b, n1, c).permute(0, 2, 1).contiguous()  # [B, C, N]
